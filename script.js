...
function addNewStudent() {
  ...
  tdAction.innerHTML = '<button id="table-button" onclick="updateStudent(\'' +
...
function updateBatch(rowId) {
  let batchno = window.prompt('Enter the student number and batch number in comma seperated values');
  // batchno = 1,2020
  ...
  elem_row.tdBatch.textContent = batch
